...
$def[1] .= rrd::area("var1", "#a9a9a9", "Total") ;
$def[1] .= rrd::gprint("var1", array("LAST", "AVERAGE", "MAX"), "%6.2lfGB");
$def[1] .= rrd::line1("var3", "#5a3d99", "Free") ;
$def[1] .= rrd::gprint("var3", array("LAST", "AVERAGE", "MAX"), "%6.2lfGB");
$def[1] .= rrd::line1("var4", "#e5ca44", "Cache") ;
$def[1] .= rrd::gprint("var4", array("LAST", "AVERAGE", "MAX"), "%6.2lfGB");
$def[1] .= rrd::line1("var2", "#ff0000", "Used") ;
$def[1] .= rrd::gprint("var2", array("LAST", "AVERAGE", "MAX"), "%6.2lfGB");
?>
